...
public class TC_03_Quality_Inspection_for_2_Batch extends BaseClass
{
	...
	public static void Quality_Inspection() throws Exception
	{
		...
		for(int i=2; i<=5;i++)
		{
			...
			//***************************************************************************************************************
			//Sampling Quantity UOM -if we are creating 2 batch for same material thn give one BaseUOM and other as Alternate UOM
			//***************************************************************************************************************
			...
			if(t)
			{
				...
				w.SampledQuantityUOM(Basic_UOM);
			}
			System.out.println(Action);
			...
			//***************************************************************************************************************
			w.SMPL();
			w.ARNumber(AR_Number_RM_B2);//***********AR Number for Batch 2
			//***************************************************************************************************************
			w.Action(Action);
			System.out.println(Action);
