...
public class TC_02_Goods_Recipt_With_PO_Split_3_Batch extends BaseClass
{
	...
	public static void Ordertypr() throws Exception
	{
		...
		w.WareHouse();
		w.Goods_Receipt();Thread.sleep(9500);
		w.Menu_Navigate();Thread.sleep(1000);
		...
		for(int i=2; i<=4;i++)
		{
			...
			w.Container_No(ContainerC);// 3 Container
			...
			driver.findElement(By.xpath("//input[@formcontrolname='manufactureDate']")).click();Thread.sleep(8000);
			driver.findElement(By.xpath("//*[@formcontrolname='retestDate']")).click();Thread.sleep(8000);
			driver.findElement(By.xpath("//*[@formcontrolname='expiryDate']")).sendKeys(Date6ML);Thread.sleep(8000);//NotRequired
			driver.findElement(By.xpath("//*[@formcontrolname='dcDate']")).click();Thread.sleep(8000);
			...
			driver.findElement(By.xpath("(//*[@type='date'])[8]")).sendKeys(DateToday);Thread.sleep(2000);//Manufacturing Date
			driver.findElement(By.xpath("(//*[@type='date'])[9]")).sendKeys(OneMonthLater);Thread.sleep(2000);//Vendor Retest Date
			driver.findElement(By.xpath("(//*[@type='date'])[10]")).sendKeys(OneYearLater);Thread.sleep(2000);//Vendor Expiry Date
