...
public class TC_11_01_Batch_Order_FP_Add_1RM_1SFG extends BaseClass
{
	...
	public static void Bill_Of_Material() throws Exception
	{
		...
		for(int i=2; i<=2;i++)
		{
			...
			w.DD_04("");
			w.Batch_Number(Batch_Number_FP);//**********************Malli  use
			...
			//****************************************************************************************************
			w.SearchBox(Batch_Number_FP);Thread.sleep(2000);//***************************
			//****************************************************************************************************
