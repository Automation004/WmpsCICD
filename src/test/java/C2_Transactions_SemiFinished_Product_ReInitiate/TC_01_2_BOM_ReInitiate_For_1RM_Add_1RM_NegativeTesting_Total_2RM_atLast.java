...
public class TC_01_2_BOM_ReInitiate_For_1RM_Add_1RM_NegativeTesting_Total_2RM_atLast extends BaseClass
{
	...
	public static void Bill_Of_Material() throws Exception
	{
		...
		for(int i=2; i<=2;i++)
		{
			...
			//***************************************************************************************************************
			//******************Again Adding 1st Raw Material in KSM Box after deleting entire KSM Box*********************
			//***************************************************************************************************************
			...
			w.TT_14(Low2);//Low
			//***************************************************************************************************************
			//******************Again Adding 2nd Raw Material in KSM Box after deleting entire KSM Box*********************
			...
			//***************************************************************************************************************
			//**************************Added 2nd Raw Material in KSM Box after deleting entire KSM Box************************
			//***************************************************************************************************************
			scrollPagedown();
