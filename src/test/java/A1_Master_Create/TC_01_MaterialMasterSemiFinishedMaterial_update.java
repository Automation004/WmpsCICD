...
public class TC_01_MaterialMasterSemiFinishedMaterial_update extends BaseClass {
	@Test
		...
		try {
			...
			for (int i = 2; i <= 2; i++) {
				try {
					...
					Test.log(Status.INFO, "Entered Material Type SFP " + Material_Type_SFP);

					driver.findElement(By.xpath("//*[@formcontrolname='materialCode']")).sendKeys(MaterialCodeSFP);
					Test.log(Status.INFO, "Entered Material Code " + MaterialCodeSFP);
					...
					Test.log(Status.INFO, "Entered Material Description " + MaterialMasterSFP);
