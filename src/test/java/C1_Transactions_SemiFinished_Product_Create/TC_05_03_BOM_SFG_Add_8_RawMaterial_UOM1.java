...
public class TC_05_03_BOM_SFG_Add_8_RawMaterial_UOM1 extends BaseClass {
	...
	public static void Bill_Of_Material() throws Exception {
		...
		for (int i = 2; i <= 2; i++) {
			...
			Select UOM1 = new Select(driver.findElement(By.xpath(
					"(/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/select)[1]")));
			UOM1.selectByIndex(0);
			Thread.sleep(2000);
			Select UOM2 = new Select(driver.findElement(By.xpath(
					"(/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/select)[2]")));
			UOM2.selectByIndex(0);
			Thread.sleep(2000);
			Select UOM3 = new Select(driver.findElement(By.xpath(
					"(/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/select)[3]")));
			UOM3.selectByIndex(0);
			Thread.sleep(2000);
			Select UOM4 = new Select(driver.findElement(By.xpath(
					"(/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/select)[4]")));
			UOM4.selectByIndex(0);
			Thread.sleep(2000);
			Select UOM5 = new Select(driver.findElement(By.xpath(
					"(/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/select)[5]")));
			UOM5.selectByIndex(0);
			Thread.sleep(2000);
			Select UOM6 = new Select(driver.findElement(By.xpath(
					"(/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/select)[6]")));
			UOM6.selectByIndex(0);
			Thread.sleep(2000);
			Select UOM7 = new Select(driver.findElement(By.xpath(
					"(/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/select)[7]")));
			UOM7.selectByIndex(0);
			Thread.sleep(2000);
			Select UOM8 = new Select(driver.findElement(By.xpath(
					"(/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/select)[8]")));
			UOM8.selectByIndex(0);
			Thread.sleep(2000);
