...
public class TC_05_02_BOM_SFG_Add_2RM_No_KSM extends BaseClass
{
	...
	public static void Bill_Of_Material() throws Exception
	{
		...
		for (int i = 2; i <= 2; i++)
		{
			...
			w.BPR_Number(BPR_Number_SFG_I);Thread.sleep(2000);// ***********************UNIQUE
			...
			driver.findElement(By.xpath("/html/body/app-root/div/div/app-bom/div/div[2]/div[2]/div/div[2]/div/div/table/tbody[1]/tr[1]/td[9]/button[1]/i")).click();
			Thread.sleep(2000);
